...
// `capture_guest_ugc()` (SECURITY DEFINER, migración 0149, valida "post-estancia" y
 ...
 * misma interacción, ver migración 0149). Esta es la lista cruda: filtrar lo usable es
