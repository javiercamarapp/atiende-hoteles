...
// (packages/db/migrations/0150_hotel_exchange_rate.sql) -- el módulo de dominio sigue
 ...
 *  `hotel_exchange_rate.to_currency` (0150) documenta el mismo default en la base de
 ...
 *  de 0150_hotel_exchange_rate.sql: "una tasa ya registrada no se edita ni se borra").
 *  Un error de captura se corrige registrando una fila nueva con la fecha correcta --
 *  esta función nunca hace UPDATE, refleja exactamente la RLS de 0150 (solo hay policy
