-- ORIGEN: packages/db/migrations/0155_room_charge_capture_attempt_charge_unique.sql sha256:ca65f5f362973cb656bd645e3fde83789c38439fe42dd8c38db15d216265ca35
...
-- 0152) hace fail-closed a nivel de BD la invariante "un `charge` real solo puede
...
--
-- Expand-only sobre 0152 (REQ-GOB-011): ninguna migración ya aplicada se edita; esto
