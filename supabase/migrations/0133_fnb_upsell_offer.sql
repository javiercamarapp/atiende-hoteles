-- ORIGEN: packages/db/migrations/0133_fnb_upsell_offer.sql sha256:16a5eb732d18481479bad76720b370eb33c4cb902a3472c2883ca807dd8942ff
...
--     apunta a un `menu_item` REAL (REQ-AB-001, migración 0132), nunca a un precio
...
-- Mismo criterio que `menu_item` (0132): gestionar las ofertas de upsell es
...
begin
  ...
  if v_existing_id is not null then
    ...
    -- ya existía tal cual, mismo criterio que `location_code` (0132) siendo
