...
## D-006 — [2026-09-06 default aplicado: precios de los 3 planes SaaS marcados `es_propuesta = true`, configuración editable, ninguna fila cerrada como precio de lista] — Decisión pendiente del usuario: precio de lista definitivo de los planes Starter/Pro/Enterprise (EXPUESTA, no bloquea trabajo)
