 ...
 *      en el índice único de la migración 0132, esta función es la razón por la que esa
 ...
 *  -- catálogo cerrado, igual que `location_type` en la migración 0132. */
 ...
 * migración 0132) -- esta función solo define la REGLA de cómo se deriva el código.
 *
 ...
 *  `menu_item.allergens` en la migración 0132 (NOM-051 + los alérgenos mayores UE,
