 ...
 * `public.trigger_fnb_upsell_offer` (migración 0154), que es la que de verdad hace
 ...
 * migración 0153) -- el catálogo real gestionado exclusivamente por los roles
 ...
 * 0154, mismo criterio que `buildLocationCode`/`menu_qr_location`).
 *
