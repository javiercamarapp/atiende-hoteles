...
//
// La captura en sí (fila `guest_ugc_submission`, migración 0131) y el registro de
// consentimiento que la acompaña (tabla `consent` ya existente desde REQ-HUE-024/
// REQ-SEG-002, `consent_kind` ampliado con 'ugc' en la migración 0130) viven en
...
export interface GuestUgcSubmission {
   ...
   *  migración 0131) -- `false` significa "el huésped mandó el contenido pero negó
